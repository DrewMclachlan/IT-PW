    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_req', models.IntegerField(choices=[('17', '17'), ('18', '18'), ('19', '19'), ('20', '20'), ('21', '21'), ('22', '22'), ('23', '23'), ('24', '24'), ('25', '25'), ('26', '26'), ('27', '27'), ('28', '28'), ('29', '29'), ('30', '30')])),
                ('lang_req', models.CharField(choices=[('E', 'English'), ('F', 'French'), ('G', 'German'), ('K', 'Korean')], max_length=128)),
                ('ed_req', models.CharField(choices=[('s', 'School'), ('c', 'College'), ('u', 'Undergraduate'), ('p', 'Postgraduate')], max_length=128)),
